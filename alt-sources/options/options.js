...
const fieldExtraText = document.getElementById('field-extra-text');
...
function renderSources(sources) {
  ...
  for (const source of sources) {
    ...
    if (source.extraText) badges.appendChild(makeBadge(`+ "${source.extraText}"`));
...
function openEdit(source) {
  ...
  fieldExtraText.value = source.extraText || '';
...
function getFormSource() {
  return {
    ...
    extraText: fieldExtraText.value,
...
[fieldBaseUrl, fieldExtraText, previewTitle, previewYear]
